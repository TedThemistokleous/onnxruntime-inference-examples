...
def parse_input_args():
    ...
    parser.add_argument(
        ...
        required=False,
        default="MIGraphX",
        choices=['MIGraphX', 'ROCm', 'CPU'],
        help='The desired execution provider [MIGraphX, ROCm, CPU] are the options; Default is MIGraphX',
    )
...
if __name__ == '__main__':
    '''
    INT8 Inference on InceptionV3 model
    ...
    if execution_provider == "MIGraphXExecutionProvider":
    ...
    if execution_provider == "MIGraphXExecutionProvider":
        os.environ["ORT_MIGRAPHX_FP16_ENABLE"] = "1" if flags.fp16 else "0"
